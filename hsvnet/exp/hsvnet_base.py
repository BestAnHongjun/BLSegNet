...
class Exp(BaseExp):
    def __init__(self):
        ...
        # dir of dataset images, if data_dir is None, this project will use `dataset` dir
        self.data_dir = None
    ...
    def get_model(self):
        from hsvnet.model import HSVNet, PAFPN, HSVHead
        ...
        if getattr(self, "model", None) is None:
            ...
            head = HSVHead(self.width, in_channel=in_channels, act=self.act)
            self.model = HSVNet(backbone, head)
    ...
    def get_lr_scheduler(self, lr, iters_per_epoch):
        from hsvnet.utils import LRScheduler
    ...
    def get_evaluator(self, batch_size):
        from hsvnet.data import Evaluator
    ...
    def get_trainer(self, args):
        from hsvnet.core import Trainer
