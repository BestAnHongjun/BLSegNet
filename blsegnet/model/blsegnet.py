...
from blsegnet.model.pafpn import PAFPN
from blsegnet.model.blseg_head import BLSegHead
from blsegnet.loss import MIoULoss, FocalLoss


class BLSegNet(nn.Module):
    def __init__(self, backbone=None, head=None, depthwise=False, pafpn=True):
        ...
        if head is None:
            head = BLSegHead(width=0.25, depthwise=depthwise)
